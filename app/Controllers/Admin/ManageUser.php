    ...
    public function index()
    {
        ...
        if (empty($situs) || user()->level == 'staff' || user()->level == 'kepala dusun') {
            ...
            if (user()->level == 'super admin') {
                $user = $this->userModel->orderBy('level', 'ASC')->orderBy('username', 'ASC')->findAll();
            } else {
                $user = $this->userModel->where('level !=', 'super admin')->orderBy('level', 'ASC')->orderBy('username', 'ASC')->findAll();
            }
